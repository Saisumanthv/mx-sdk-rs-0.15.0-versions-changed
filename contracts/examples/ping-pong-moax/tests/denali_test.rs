...
fn ping_pong_call_ping() {
	parse_execute_denali("denali/ping-pong-call-ping.scen.json", &contract_map());
}
...
fn ping_pong_call_pong() {
	parse_execute_denali("denali/ping-pong-call-pong.scen.json", &contract_map());
}

#[test]
fn ping_pong_call_pong_all() {
	parse_execute_denali("denali/ping-pong-call-pong-all.scen.json", &contract_map());
}
...
#[test]
fn ping_pong_init() {
	parse_execute_denali("denali/ping-pong-init.scen.json", &contract_map());
}
