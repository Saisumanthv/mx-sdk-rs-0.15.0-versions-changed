...
- ticket_price: The price of the ticket in MOA wei (1 MOA/MOAX = 10^18 MOA wei). For example, 2000000000000000000 for 2 MOAX ticket price.
...
*prize\_pool*: the accumulated MOAX up until now.
...
All you need to do is pass along the name of the lottery you wish to purchase the ticket for and deposit the appropriate sum of MOAX, corresponding to the ticket cost.
