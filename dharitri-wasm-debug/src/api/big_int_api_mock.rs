...
impl dharitri_wasm::abi::TypeAbi for RustBigInt {
	fn type_name() -> String {
		String::from("BigInt")
	}
}

impl dharitri_wasm::api::BigIntApi<RustBigUint> for RustBigInt {
	fn abs_uint(&self) -> RustBigUint {
		RustBigUint(self.0.abs())
	}

	fn sign(&self) -> dharitri_wasm::api::Sign {
		match self.0.sign() {
			num_bigint::Sign::Minus => dharitri_wasm::api::Sign::NoSign,
			num_bigint::Sign::NoSign => dharitri_wasm::api::Sign::NoSign,
			num_bigint::Sign::Plus => dharitri_wasm::api::Sign::Plus,
		}
	}
