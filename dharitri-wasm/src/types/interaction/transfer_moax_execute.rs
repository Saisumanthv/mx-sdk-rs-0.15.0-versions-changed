...
#[must_use]
pub struct TransferMoaxExecute<BigUint: BigUintApi> {
	pub(super) to: Address,
	pub(super) moax_payment: BigUint,
	pub(super) endpoint_name: BoxedBytes,
	pub(super) arg_buffer: ArgBuffer,
	pub(super) gas_limit: u64,
}

impl<BigUint> TransferMoaxExecute<BigUint>
where
	BigUint: BigUintApi + 'static,
{
	pub fn with_gas_limit(self, gas_limit: u64) -> Self {
		TransferMoaxExecute { gas_limit, ..self }
	}
}
